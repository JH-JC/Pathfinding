...
public class Graph  { 
    ...
    private void startPro() { //Start all the UI stuff, this is ESSENTIAL when creating programs that contain a UI
        ...
        start.addActionListener(new ActionListener() {
            @Override //This basically means, whatever button is pressed will just be that button and no other, triggering a response when clicked
    ...
    public void delays() { //Delay method
        ...
        try {
            Thread.sleep(delays); //Set delay timer
        } catch (Exception e) {}
